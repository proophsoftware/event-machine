...
use Prooph\EventMachine\Projecting\InMemory\InMemoryEventStoreProjector;
...
class InMemoryEventStoreProjectorTest extends AbstractEventStoreProjectorTest
{
    ...
    public function it_throws_exception_when_unknown_event_store_instance_passed(): void
    {
        ...
        new InMemoryEventStoreProjector($eventStore->reveal(), $this->inMemoryConnection, 'test_projection', 10, 10);
    }
    ...
    public function it_throws_exception_when_invalid_wrapped_event_store_instance_passed(): void
    {
        ...
        new InMemoryEventStoreProjector($wrappedEventStore->reveal(), $this->inMemoryConnection, 'test_projection', 1, 1);
    }
    ...
    public function it_throws_exception_when_invalid_cache_size_given(): void
    {
        ...
        new InMemoryEventStoreProjector($this->eventStore, $this->inMemoryConnection, 'test_projection', -1, 1);
    }
